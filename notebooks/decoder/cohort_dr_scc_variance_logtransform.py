...
# %% [markdown]
# # Cohort DR-SCC (Variance + Log-Transform)
# Same as the variance decoder but with log-transformed power features.
# Log transform is applied per-recording before weekly mean/variance aggregation,
# compressing right-skewed power distributions for better ElasticNet behavior.
...
# %% [markdown]
# # Train, test, validate the weekly decoder (variance + log-transform)
